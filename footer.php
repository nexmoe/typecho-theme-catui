...
<div class="footer">
    <div class="copyright container">&copy; <?php echo date("Y");?> <?php $this->options->title(); ?>Theme By <a href="https://github.com/theme-catui/typecho-theme-catui" target="_blank">Cat UI</a></div>
</div>
